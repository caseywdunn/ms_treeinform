...
# Figure 1: Histogram of subtree heights from clades of genes from the same species (Motivation)

```{r, subtree_histo, echo=FALSE, warning=FALSE}
...
ggplot(heights, aes(height)) + geom_histogram(binwidth=0.01) + theme_classic()
```

# Figure 2: Mixture model fit (Justification)
