...
# + scale_x_sqrt(breaks = trans_breaks("sqrt", function(x) x^2), labels = trans_format("sqrt", math_format(.x^2))) more striking difference on sqrt scale, but harder to compare with Figure 2
```
