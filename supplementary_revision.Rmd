...
#tiff(filename="Figures/corset_cluster.tiff",width=7,height=5,family="Arial",units="in",pointsize=8,res=350)
...
#tiff(filename="Figures/corset_lengths.tiff",width=7,height=5,family="Arial",units="in",pointsize=8,res=350)
...
#tiff(filename="Figures/reassigned.tiff",width=7,height=5,family="Arial",units="in",pointsize=8,res=350)
...
#tiff(filename="Figures/validate.tiff",width=7,height=5,family="Arial",units="in",pointsize=8,res=350)
